...
# Enhanced startup script for QEMU VM Manager with 20 VMs
...
echo "=== QEMU VM Manager - Enhanced Startup (20 VMs) ==="
echo "Project Directory: $PROJECT_DIR"

# Function to check port availability
check_ports() {
    echo "Checking port availability (8000-8019)..."
    local ports_in_use=()
    ...
    echo "All required ports (8000-8019) are available."
    return 0
}
...
check_disk_space() {
    ...
    local required_gb=$((20 * 20 + 10))  # 20 VMs * 20GB each + 10GB overhead
...
# Confirm with user
echo ""
echo "=== Ready to Create 20 VMs ==="
echo "This will:"
echo "- Create 20 Ubuntu Desktop VMs"
echo "- Each VM will have 20GB disk space"
echo "- Each VM will have unique VPN configuration"
echo "- Each VM will have VNC access on ports 5900-5919"
echo "- Total disk usage: ~400GB"
echo ""
